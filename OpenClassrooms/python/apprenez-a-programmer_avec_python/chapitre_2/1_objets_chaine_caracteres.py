...
chaine[0]
chaine[2]
chaine[-1] #Accède à la dernière lettre de la chaine

chaine = "Salut"
print(len(chaine)) #Longueur de la chaine
i = 0
while i<len(chaine) :
    print(chaine[i]) # On affiche le caractère à chaque tour de boucle
    i+=1
#Levée d'une exception IndexError si l'indice n'existe pas

#On ne peut pas utiliser les indices pour changer les lettres
...
#Il y a les méthodes count, find, replace pour rechercher/remplacer
